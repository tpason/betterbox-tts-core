...
set -- python scripts/story_pipeline/audio_segment_worker_vieneu.py \
  ...
  --voice-key "${AUDIO_SEGMENT_VIENEU_VOICE_KEY:-xianxia_story_male}" \
  --voice "${AUDIO_SEGMENT_VIENEU_VOICE:-Xuân Vĩnh}" \
  --voice-profile "${AUDIO_SEGMENT_VIENEU_VOICE_PROFILE:-xianxia_story_male}" \
