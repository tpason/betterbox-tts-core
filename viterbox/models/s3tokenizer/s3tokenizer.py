...
class S3Tokenizer(S3TokenizerV2):
    ...
    def __init__(
        ...
        super().__init__(name)
        if config is None:
            # Tránh dùng default object mutable cho tham số cấu hình.
            config = ModelConfig()
    ...
    def _prepare_audio(self, wavs):
        ...
        # Cho phép truyền 1 tensor duy nhất hoặc list tensor/ndarray như cũ.
        ...
        for wav in wavs:
            ...
            if wav.dim() == 1:
                wav = wav.unsqueeze(0)
            # Chuẩn hóa dtype/layout để giảm warning + tăng ổn định khi STFT.
