        ...
        for item in batch:
            ...
            if len(value) == 3:
                ...
                waveform, sample_rate = torchaudio.load(
                    filepath=wav_path, num_frames=end_frame - start_frame, frame_offset=start_frame
                )
            else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_workers", default=0, type=int, help="num of subprocess workers for processing"
    )
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(data_loader):
            ...
            if wav_number % args.log_interval == 0:
                print(
                    f"processed {wav_number} wavs, {all_number} frames", file=sys.stderr, flush=True
                )
